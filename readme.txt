...
Installing "Social Monitor" can be done either by searching for "Social Monitor" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
